...
export function SignupForm({ role }: SignupFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // If successful, show verification message or redirect
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3">
                <input
                    ...
                    className="mt-1 w-4 h-4 rounded border-[var(--color-border)] bg-[var(--color-bg)] text-[var(--color-primary)] focus:ring-[var(--color-primary)] focus:ring-offset-0"
                    disabled={isLoading}
                />
            ...
            >
                {isLoading ? (
                    ...
                    `Create ${role === 'creator' ? 'Creator' : 'Business'} Account`
                )}
            </button>
